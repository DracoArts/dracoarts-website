...
import { Featured } from "@/public/data/games";
const Banner = () => {
  const settings = {
    infinite: true,
    autoplay: true,
              ...
              <div className="col-xl-7 col-lg-7">
                <div className="main-content">
                  <div className="mb-8">
                    ...
                    <p className="fs-four">
                      Creating original, entertaining, and visually striking video games
                    </p>
                  </div>
                  <PrimaryBtn text="Explore Our Games" href="games" />
                </div>
              </div>
                ...
                <Slider {...settings} className="game-carousel pb-20">
                  ...
                  <div className="slide-area">
                    ...
                    <div className="single-slider p-3 p-sm-5">
                      <div className="thumb-wrapper">
                        <div className="thumb">
                          <Image layout="resposive" width={360} height={640} src={Featured.image} alt="Image" />
                        </div>
                        <div className="app-download-title pt-5 pb-3 text-center">
                          <h3>{Featured.name}</h3>
                        </div>
