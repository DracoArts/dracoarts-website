...
import fav from "@/public/images/draco-logo.svg";
import logo from "@/public/images/text-draco.svg";
...
const Header = () => {
  ...
  return (
    <>
      ...
      <header
        className={`header-section header-menu ${headerFixed && "animated fadeInDown header-fixed"
          }`}>
        <nav className="navbar w-100 flex-nowrap px-2 py-6 ps-2 ps-xl-10 ps-xxl-10 navbar-expand-xl">
          <div
            ...
            <Link
              ...
              className="navbar-brand ms-4 ms-xxl-20 d-flex align-items-center gap-3">
              <Image  style={{"maxWidth":"60px"}} src={fav} className="logo" alt="logo" />
              <Image
                 style={{"maxWidth":"60px"}}
                src={logo}
          ...
          <div
            ...
            <ul className="navbar-nav d-xl-flex d-none gap-3 py-4 py-lg-0 m-auto pe-20 align-self-center">
              ...
              <Link
                className={`dropdown-nav ${path == "/" && "active"}`}
                href="/">
                Home
              </Link>

              <Link
                className={`dropdown-nav ${path == "/games" && "active"}`}
                href="/games">
                Games
              </Link>
              ...
              <li className="dropdown show-dropdown">
                <button
                  type="button"
                  aria-label="Navbar Dropdown Button"
                  className={`dropdown-toggle dropdown-nav ${ourServices && "active"
                    }`}>
                  Services
                </button>
                <ul className="dropdown-menu">
              ...
              <li className={`dropdown show-dropdown`}>
                <button
                  type="button"
                  aria-label="Navbar Dropdown Button"
                  className={`dropdown-toggle dropdown-nav ${pages && "active"
                    }`}>
                  Legal
                </button>
                <ul className="dropdown-menu">
              ...
              {/* <li className="dropdown show-dropdown">
                <button
                  type="button"
                  aria-label="Navbar Dropdown Button"
                  className={`dropdown-toggle dropdown-nav ${(path == "/blog" || path == "/blog-single") && "active"
                    }`}>
                  blog
                </button>
                <ul className="dropdown-menu">
            ...
            <div className="right-area position-relative d-flex gap-3 gap-xxl-6 align-items-center">
              ...
              <div className="contact-info ms-xl-0 ms-xxl-5 d-none d-sm-flex align-items-center gap-0">
                <i className="material-symbols-outlined mat-icon"> smartphone </i>
                <span>(971) 569-3159-53</span>
              </div>
