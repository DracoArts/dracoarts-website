  ...
  const socialData = [
    {
      id: 1,
      name: "Instagram",
      link: "https://www.instagram.com/dracoartsgames/",
    ...
    
    {
      id: 3,
      name: "Linkedin",
      link: "https://www.linkedin.com/company/3609171",
      icon: <i className="fab fa-linkedin-in"></i>,
    },
    {
      id: 4,
      name: "Twitter",
      link: "https://x.com/DracoArts_Games",
          ...
          <ul className="d-flex justify-content-around">
            {socialData.map(({ id, name, icon, link }) => (
              <li
                ...
                style={style}>
                <Link target="_blank" href={link} className="d-center gap-2">
                  {icon}
                  <span>{name}</span>
                </Link>
              </li>
                ...
                <div className="content-area visible-from-bottom">
                  <div className="section-area">
                    ...
                    <p className="mt-4 w-75">
                      Draco Arts is a premier gaming studio creating innovative
              ...
              <div className="col-md-6 text-center">
                <div className="copyright">
                  <p>
                    ...
                    <Link href="/">Draco Arts</Link> - All Right Reserved
                  </p>
                </div>
              </div>
            </div>
